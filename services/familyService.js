...
function updateCareReminder(id, partial) {
  ...
  return request(`/households/${getHouseholdId()}/care_reminders/${id}`, "PATCH", partial || {});
}
...
function deleteCareReminder(id) {
  ...
  return request(`/households/${getHouseholdId()}/care_reminders/${id}`, "DELETE");
}
...
function createHelpRequest(type, message) {
  ...
  return request(`/households/${getHouseholdId()}/help_requests`, "POST", {
    type,
    message: message || "",
  });
}
...
function listDailyStatuses() {
  ...
  return request(`/households/${getHouseholdId()}/daily_statuses`);
}
...
function addDailyStatus(payload) {
  ...
  return request(`/households/${getHouseholdId()}/daily_statuses`, "POST", payload);
}
...
function getStatusDigest() {
  ...
  return request(`/households/${getHouseholdId()}/daily_statuses/digest`);
}
...
function listHelpRequests() {
  ...
  return request(`/households/${getHouseholdId()}/help_requests?limit=50`);
}
...
function cancelHelpRequest(id) {
  ...
  return request(`/households/${getHouseholdId()}/help_requests/${id}/cancel`, "POST", {});
}
...
function getWeeklyReport() {
  ...
  return request(`/households/${getHouseholdId()}/weekly_reports/latest`);
}
...
function generateWeeklyReport() {
  ...
  return request(`/households/${getHouseholdId()}/weekly_reports/generate`, "POST", {});
}
...
function bootstrapHouseAdmin() {
  ...
  return request(`/households/${getHouseholdId()}/admin/bootstrap`, "POST", {});
}
